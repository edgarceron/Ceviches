	...
	<div class="card">
		...
		<div class="card-body">
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				'action'=>Yii::app()->createAbsoluteUrl('/productos/default/listTiposVariable'),
				'method'=>'get',
						...
						(
							...
							(
								...
								(
									...
									'url'=>'Yii::app()->createUrl("productos/default/formTipoVariable", array("id"=>$data->id))',
								),
							),
						)
