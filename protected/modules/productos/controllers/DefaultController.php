...
class DefaultController extends Controller
{
	...
	public function actions()
	{
		return array(
			...
			'formVariable'=>'application.modules.'.$this->module->id.'.controllers.acciones.FormVariableAction',                            
			...
			'formTipoVariable'=>'application.modules.'.$this->module->id.'.controllers.acciones.FormTipoVariableAction',                            
			'list'=>'application.modules.'.$this->module->id.'.controllers.acciones.ListAction',                            
			'listLineasProducto'=>'application.modules.'.$this->module->id.'.controllers.acciones.ListLineasProductoAction',                            
			'listTiposVariable'=>'application.modules.'.$this->module->id.'.controllers.acciones.ListTiposVariableAction',                            
			'listVariables'=>'application.modules.'.$this->module->id.'.controllers.acciones.ListVariablesAction',                            
			'listTiposProducto'=>'application.modules.'.$this->module->id.'.controllers.acciones.ListTiposProductoAction',                            
    ...
    public function accessRules()
	{
		return array(	
			...
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('formTipoVariable'),
                                'expression' => array(__CLASS__,'allowFormTipoVariable'),
                            ),		
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('formVariable'),
                                'expression' => array(__CLASS__,'allowFormVariable'),
                            ),		
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('listLineasProducto'),
                                'expression' => array(__CLASS__,'allowListLineasProducto'),
                            ),	
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('listTiposVariable'),
                                'expression' => array(__CLASS__,'allowListTiposVariable'),
                            ),	
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('listTiposProducto'),
                                'expression' => array(__CLASS__,'allowListTiposProducto'),
                            ),	
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('listVariables'),
                                'expression' => array(__CLASS__,'allowListVariables'),
                            ),	
	...
	public static function allowListLineasProducto()
	{
		/*
		$accion = 'listLineasProducto'; 
		if(Yii::app()->user->name != "Guest"){
			$usuario = SofintUsers::model()->findByPk(Yii::app()->user->id);
			$criteria = new CDbCriteria();            
			$modulo = 'productos';
	...
	public static function allowFormVariable()
	{
		/*
		$accion = 'formVariable'; 
		if(Yii::app()->user->name != "Guest"){
	...
	public static function allowListTiposVariable()
	{
		/*
		$accion = 'listTiposVariable'; 
		if(Yii::app()->user->name != "Guest"){
			$usuario = SofintUsers::model()->findByPk(Yii::app()->user->id);
			$criteria = new CDbCriteria();            
			$modulo = 'productos';
	...
	public static function allowListTiposProducto()
	{
		/*
		$accion = 'listTiposProducto'; 
		if(Yii::app()->user->name != "Guest"){
			$usuario = SofintUsers::model()->findByPk(Yii::app()->user->id);
			$criteria = new CDbCriteria();            
			$modulo = 'productos';
	...
	public static function allowListVariables()
	{
		/*
		$accion = 'listVariables'; 
		if(Yii::app()->user->name != "Guest"){
			$usuario = SofintUsers::model()->findByPk(Yii::app()->user->id);
			$criteria = new CDbCriteria();            
			$modulo = 'productos';
	...
	public static function allowFormTipoVariable()
	{
		/*
		$accion = 'allowFormTipoVariable'; 
		if(Yii::app()->user->name != "Guest"){
			$usuario = SofintUsers::model()->findByPk(Yii::app()->user->id);
			$criteria = new CDbCriteria();            
			$modulo = 'productos';
