 ...
 * @property integer $id
 * @property integer $id_tipo_varible
 * @property string $descripcion_tipo_variable
 *
 * The followings are the available model relations:
 * @property TiposVariable $idTipoVarible
...
class Variables extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_tipo_varible, descripcion_tipo_variable', 'required'),
			array('id_tipo_varible', 'numerical', 'integerOnly'=>true),
			array('descripcion_tipo_variable', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_tipo_varible, descripcion_tipo_variable', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idTipoVarible' => array(self::BELONGS_TO, 'TiposVariable', 'id_tipo_varible'),
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'id_tipo_varible' => 'Id Tipo Varible',
	...
	public function search()
	{
		...
		$criteria->compare('id_tipo_varible',$this->id_tipo_varible);
